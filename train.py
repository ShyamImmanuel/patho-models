...
parser.add_argument('-data_path', default='dataset/', help="Path to PCam HDF5 files.")
parser.add_argument('-save_path', default='models/', help="Path to save trained models")
parser.add_argument('-lr', default=1e-3, type=float, help="Learning rate")
parser.add_argument('-batch_size', default=32, type=int, help="Batch size")
parser.add_argument('-n_iters', default=100, type=int, help="Number of train iterations")
parser.add_argument('-device', default=0, type=int, help="CUDA device")
parser.add_argument('-save_freq', default=100, type=int, help="Frequency to save trained models")
