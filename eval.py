...
parser.add_argument('-data_path', default='dataset/', help="Path to test HDF5 files.")
parser.add_argument('-results_path', default='results/', help='Folder to save results file in')
parser.add_argument('-saved_model',  default='models/', help="Path to trained model file")
...
model.load_state_dict(torch.load('C:/Users/shyam.i.albert/Documents/python-models/metastasis-detection/models/model-00100.pth'))
model.to(device)
model.eval()
